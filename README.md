 ...
 **`begin`**<br>
 ...
 ## Testing
 To test, first make sure the functions you implemented all compile by clicking the check mark; make sure that you have chosen `Arduino Nano Every` as the target. Work through any syntax errors you may have. It might get a little frustrating, especially if you aren't very familiar with C++. Feel free to reach out in the firmware channel if you get stuck on anything specific.
